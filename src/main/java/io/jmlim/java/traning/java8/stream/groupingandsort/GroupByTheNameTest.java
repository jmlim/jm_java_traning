...
public class GroupByTheNameTest {
    public static void main(String[] args) {
        ...
        Map<Integer, Long> qtycounting = items.stream().collect(Collectors.groupingBy(Item::getQty, Collectors.counting()));
        System.out.println(qtycounting);
